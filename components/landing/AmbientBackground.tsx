    ...
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div
        ...
        style={{
          ...
          filter: "blur(42px)", animation: "amb1 26s ease-in-out infinite",
      ...
      <div
        ...
        style={{
          ...
          filter: "blur(52px)", animation: "amb2 32s ease-in-out infinite",
          willChange: "transform",
        }}
      />
      <div
        ...
        style={{
          ...
          filter: "blur(58px)", animation: "amb3 38s ease-in-out infinite",
          willChange: "transform",
        }}
      />
      ...
      {/* Glass overlay — reduced blur radius for Firefox compositor performance.
          A static paper tint replaces the brightness() filter pass. */}
      <div
