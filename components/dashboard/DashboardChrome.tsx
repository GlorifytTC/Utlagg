  ...
  return (
    <div className="flex h-full flex-col">
      <div className="px-5 pb-5 pt-6">
        ...
        <p className="mt-0.5 text-[9.5px] uppercase tracking-[0.15em] text-gray-400 dark:text-gray-600">Expense Management</p>
      </div>
      <nav className="flex-1 min-h-0 overflow-y-auto px-3 py-4">
        <p className="mb-1.5 px-2.5 text-[9px] font-medium uppercase tracking-[0.18em] text-gray-400 dark:text-gray-600">Menu</p>
      ...
      <div className="space-y-px border-t border-gray-900/[0.06] p-3 dark:border-white/[0.06]">
        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={() => { toggleLanguage(); router.refresh(); }} className="flex w-full items-center gap-2.5 rounded-xl px-2.5 py-[7px] text-sm text-gray-500 hover:bg-gray-900/[0.04] dark:text-gray-400 dark:hover:bg-white/[0.04]">
          <span className="h-[15px] w-[15px] text-center text-xs font-bold">{lang === "sv" ? "EN" : "SV"}</span>
          <span>{lang === "sv" ? "English" : "Svenska"}</span>
        </motion.button>
        <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} onClick={toggleTheme} className="flex w-full items-center gap-2.5 rounded-xl px-2.5 py-[7px] text-sm text-gray-500 hover:bg-gray-900/[0.04] dark:text-gray-400 dark:hover:bg-white/[0.04]">
        ...
        {open && (
          ...
          >
            ...
            <motion.aside
              ...
              className="absolute left-0 top-0 h-full w-72 max-w-[80%] bg-white shadow-xl dark:bg-gray-900"
            >
